...
#restart-solver
let rec matrix_fold_equals_fold_of_seq_folds #c #eq #m #n cm generator
  ...
  if m=1 then (
    ...
    eq.reflexivity (SP.foldm_snoc cm (SB.create 1 (SP.foldm_snoc cm (SB.init n (generator 0)))));
    ...
    matrix_fold_internal cm (init subgen);
    matrix_fold_internal cm (init generator);
    ...
    assert_norm (foldm cm (init generator) == lhs);
