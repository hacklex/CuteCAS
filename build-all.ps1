...
$modules = @(
  ...
  'Core.Matrix.Triangular.fst',
  'Core.AlgebraicConstant.Field.fst',
  'Core.Polynomial.Root.fst',
  'Core.Polynomial.Product.fst',
  'Core.Polynomial.Split.fst',
  'Core.Polynomial.CRT.fst',
  'Core.Matrix.ResultantLinear.fst',
  ...
  'Core.Field.Frobenius.fst',
  'Core.Field.BerlekampFrobenius.fst',
  'Core.Field.FpEnum.fst',
  'Core.Field.BerlekampSplit.fst',
  'Core.Field.BerlekampSplitCorrect.fst',
  'Core.Polynomial.CoprimeProduct.fst',
  'Core.Field.SubstProd.fst',
  'Core.Field.BerlekampReverse.fst',
