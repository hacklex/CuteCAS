module Core.Algebra.BinomialCoefficients

(* INTERNAL — do not import directly; helper bridged into Core.Algebra.Frobenius (binomial coefficients for the freshman's dream). No .fsti by design. *)
